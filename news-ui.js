(()=>{
  ...
  function buildReaderBody(title){
    ...
    return `<div class="news-journal-blocks"><section class="news-journal-block"><h3>Kort samengevat</h3><p>${what}</p></section><section class="news-journal-block"><h3>Waarom dit boeit</h3><p>${why}</p></section><section class="news-journal-block"><h3>Belangrijkste punten</h3><ul>${bullets}</ul></section></div>`;
  }
  ...
  function openReader(item){
    ...
    if(!blocks){ blocks=document.createElement('div'); blocks.id='newsReaderBlocks'; $('#newsReaderSummary').insertAdjacentElement('afterend',blocks); }
