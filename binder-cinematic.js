...
(() => {
  ...
  cinematic.innerHTML=`<div class="bc-shadow"></div><div class="bc-book"><div class="bc-final-spread"><section class="bc-page bc-left"><div class="bc-grid" data-bc-grid="0"></div><small>PAGE 1</small></section><i class="bc-spine"></i><section class="bc-page bc-right"><div class="bc-grid" data-bc-grid="1"></div><small>PAGE 2</small></section></div><div class="bc-flip bc-flip-4"><div class="bc-ghost-grid"></div></div><div class="bc-flip bc-flip-3"><div class="bc-ghost-grid"></div></div><div class="bc-flip bc-flip-2"><div class="bc-ghost-grid"></div></div><div class="bc-flip bc-flip-1"><div class="bc-ghost-grid"></div></div><div class="bc-cover"><span class="bc-emblem">V</span><strong>THE VAULT</strong><small>MAGIC ARCHIVE</small></div></div></div>`;
