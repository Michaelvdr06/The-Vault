// Arcane 2.5 — fast storybook pages, page flips, final spread, zoom into page one.
(() => {
  ...
  function play(){
    ...
    timer=setTimeout(()=>{cinematic.classList.remove('is-playing');collection.classList.remove('binder-cinematic-content')},4200);
  }
